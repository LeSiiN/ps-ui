...
<div class="flex min-h-screen justify-center items-center">
	...
	>
		...
		<div class="flex flex-col h-full ">
			...
			{/each}
			<div class="flex gap-2 font-bold mt-10">
				<button
					class="ps-bg-green flex-1 hover:bg-[#30ffcb] ps-text-darkblue px-4 py-2 rounded-sm min-w-[100px]"
					on:click={submitInputs}>Submit</button
				>
				<button
					class="ps-bg-lightgrey flex-1 hover:bg-[#e7e7e7] ps-text-darkblue px-4 py-2 rounded-sm min-w-[100px]"
